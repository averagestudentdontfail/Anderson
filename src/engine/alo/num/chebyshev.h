 ...
 public:
      ...
      * @param extrapolate Whether to allow extrapolation
      */
     void evaluate(const std::vector<double>& x, std::vector<double>& y, bool extrapolate = false) const;
      ...
      */
     std::array<double, 4> evaluate4(const std::array<double, 4>& x, bool extrapolate = false) const;

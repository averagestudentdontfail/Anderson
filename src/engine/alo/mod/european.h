 ...
 *
 * @param isPut Whether to convert from call to put (true) or put to call
 * (false)
...
public:
   ...
   * @brief Constructor
   */
  EuropeanOptionFloat() = default;

  /**
   * @brief Destructor
   */
  virtual ~EuropeanOptionFloat() = default;
...
/**
 * @class EuropeanPutFloat
 * @brief Single-precision European put option pricing model
 */
class EuropeanPutFloat : public EuropeanOptionFloat {
public:
  /**
   * @brief Constructor
   */
  EuropeanPutFloat() = default;
...
/**
 * @class EuropeanCallFloat
 * @brief Single-precision European call option pricing model
 */
class EuropeanCallFloat : public EuropeanOptionFloat {
public:
  /**
   * @brief Constructor
   */
  EuropeanCallFloat() = default;
